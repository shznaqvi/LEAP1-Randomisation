...
import edu.aku.hassannaqvi.leap_randomization.contracts.FormsContract.singleForm;
import edu.aku.hassannaqvi.leap_randomization.contracts.HFacilitiesContract;
import edu.aku.hassannaqvi.leap_randomization.contracts.HFacilitiesContract.HFacilityTable;
import edu.aku.hassannaqvi.leap_randomization.contracts.LHWsContract;
import edu.aku.hassannaqvi.leap_randomization.contracts.LHWsContract.LHWTable;
import edu.aku.hassannaqvi.leap_randomization.contracts.PSUsContract;
import edu.aku.hassannaqvi.leap_randomization.contracts.PSUsContract.singleChild;
import edu.aku.hassannaqvi.leap_randomization.contracts.SourceNGOContract;
import edu.aku.hassannaqvi.leap_randomization.contracts.SourceNGOContract.SourceTable;
import edu.aku.hassannaqvi.leap_randomization.contracts.TehsilsContract;
import edu.aku.hassannaqvi.leap_randomization.contracts.TehsilsContract.TehsilTable;
import edu.aku.hassannaqvi.leap_randomization.contracts.UCsContract;
import edu.aku.hassannaqvi.leap_randomization.contracts.UCsContract.UcTable;
import edu.aku.hassannaqvi.leap_randomization.contracts.UsersContract;
import edu.aku.hassannaqvi.leap_randomization.contracts.UsersContract.singleUser;
import edu.aku.hassannaqvi.leap_randomization.contracts.VillagesContract;
import edu.aku.hassannaqvi.leap_randomization.contracts.VillagesContract.VillageTable;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_FORMS = "CREATE TABLE "
            ...
            singleForm.COLUMN_SITENUMBER + " TEXT," +
            singleForm.COLUMN_MRNUMBER + " TEXT," +
...
// Create a new map of values, where column names are the keys
        ...
        values.put(singleForm.COLUMN_SITENUMBER, fc.getSitenumber());
        values.put(singleForm.COLUMN_MRNUMBER, fc.getMrnumber());
...
// Which row to update, based on the title
    ...
    public Collection<FormsContract> getAllForms() {
        ...
        String[] columns = {
                ...
                singleForm.COLUMN_SITENUMBER,
                singleForm.COLUMN_MRNUMBER,
...
// Which row to update, based on the ID
    ...
    public int updateSiteNumber() {
        SQLiteDatabase db = this.getReadableDatabase();

// New value for one column
        ContentValues values = new ContentValues();
        values.put(singleForm.COLUMN_SITENUMBER, AppMain.fc.getSitenumber());
        values.put(singleForm.COLUMN_UID, AppMain.fc.getUID());
...
// Which row to update, based on the ID
    ...
    public int updateMRnumber() {
        SQLiteDatabase db = this.getReadableDatabase();

// New value for one column
        ContentValues values = new ContentValues();
        values.put(singleForm.COLUMN_MRNUMBER, AppMain.fc.getMrnumber());
        values.put(singleForm.COLUMN_UID, AppMain.fc.getUID());
